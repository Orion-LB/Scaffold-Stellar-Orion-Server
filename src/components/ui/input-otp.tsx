...
const InputOTPGroup = ({ ref, className, ...props }: React.ComponentPropsWithoutRef<"div"> & { ref?: React.RefObject<React.ElementRef<"div"> | null> }) => <div ref={ref} className={cn("flex items-center", className)} {...props} />;
